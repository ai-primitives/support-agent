...
// .wrangler/tmp/bundle-OgRZ2E/checked-fetch.js
...
// src/durable_objects/chat_session.ts
var ChatSession = class {
  ...
  async initialize(businessId, personaId) {
    this.chatState = {
      businessId,
      personaId,
      messages: [],
...
var RAGService = class {
  ...
  async searchKnowledge(businessId, query, topK = 5) {
    if (!query.trim()) {
  ...
  async deleteBusinessKnowledge(businessId) {
    try {
...
__name(RAGService, "RAGService");

// src/workflows/knowledge.ts
...
__name(KnowledgeWorkflow, "KnowledgeWorkflow");
...
async function testVectorize(env, embedding) {
...
__name(testVectorize, "testVectorize");
async function testQueue(env) {
...
__name(testQueue, "testQueue");
async function testWorkflow(env) {
...
__name(testWorkflow, "testWorkflow");
...
var test_default = app;

// ../../.nvm/versions/node/v22.11.0/lib/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../.nvm/versions/node/v22.11.0/lib/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-OgRZ2E/middleware-insertion-facade.js
var __INTERNAL_WRANGLER_MIDDLEWARE__ = [
  middleware_ensure_req_body_drained_default,
  middleware_miniflare3_json_error_default
];
var middleware_insertion_facade_default = test_default;

// ../../.nvm/versions/node/v22.11.0/lib/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-OgRZ2E/middleware-loader.entry.ts
